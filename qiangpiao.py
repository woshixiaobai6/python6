...
target_url = 'https://detail.damai.cn/item.htm?spm=a2oeg.home.card_0.ditem_0.1f1323e1oym8Ze&id=771603214158'
...
class Concert:
    def __init__(self):
        ...
        s = Service(executable_path='C:/Users/Administrator/AppData/Local/Google/Chrome/Application/chromedriver.exe')
